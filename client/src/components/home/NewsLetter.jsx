...
const NewsLetter = () => {
    return (
        <div className="flex flex-col items-center   max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
            <Title title="Luôn được truyền cảm hứng" subTitle='Đăng ký nhận bản tin để cập nhật điểm đến mới, ưu đãi độc quyền và cảm hứng cho chuyến đi tiếp theo.' />
            ...
            <p className="text-gray-500 mt-6 text-xs text-center">Bằng việc đăng ký, bạn đồng ý với Chính sách quyền riêng tư và chấp nhận nhận thông báo từ chúng tôi.</p>
        </div>
    )
}
